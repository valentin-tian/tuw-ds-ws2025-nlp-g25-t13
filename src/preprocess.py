...
# --- Configuration ---
# Insert your local path to the .tar archive
# e.g. r"C:\Users\user\Corpus\Schweiz.tar"
TAR_PATH = (
    r""
)
# Insert your local path to the output folder
# e.g. r"C:\Users\user\Corpus\Conllu_output"
OUTPUT_DIR = (
    r""
)
DOC_LIMIT = 10  # sample subset to keep manageable (100 was used for the Milestone 1)
